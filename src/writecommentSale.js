...
export default function ReviewcustomSale() {
          ...
          .then((response) => {
            ...
            if (response.data.Status === 'Success') {
              Swal.fire({
                ...
                Axios.put(`http://localhost:5000/updateStatusSaleCustomer/${filteredProducts.order_sale_id}`, {
                    customer_status_sale: status,
                })
                  .then((response) => {
