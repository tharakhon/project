...
export default function ReviewbankChage() {
                    ...
                    .then((response) => {
                        ...
                        if (response.data.Status === 'Success') {
                            Swal.fire({
                                ...
                                Axios.put(`http://localhost:5000/updateStatusExchagePickup/${filteredProducts.exchange_id}`, {
                                    order_exchange_pickup: status,
                                })
                                    .then((response) => {
